    ...
    Upload.prototype.upload = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (typeof window !== 'undefined' &&
                ...
                xhr_1.open('POST', _this.url, true);
                if (typeof _this.headers === 'object') {
                    try {
                        for (var _d = __values(Object.keys(_this.headers)), _e = _d.next(); !_e.done; _e = _d.next()) {
                            ...
                            xhr_1.setRequestHeader(headerName, _this.headers[headerName]);
                        }
                    }
                ...
                xhr_1.setRequestHeader('Content-Type', 'multipart/form-data');
                ...
                xhr_1.addEventListener('load', function () {
                    ...
                    switch (xhr_1.responseType) {
                        case 'json':
                            response.data = JSON.stringify(xhr_1.response);
                            break;
                        default:
                            response.data = xhr_1.response;
                    }
                    resolve(response);
                });
